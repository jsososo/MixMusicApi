...
class dataHandle {
  ...
  handleMap = {
    handle163Song: ({ name, id, ar, artists, al, album, no, mv, mvid, copyrightId, publishTime, br, url }) => ({
      name,
      id,
    ...
    handleQQAlbum: ({ id, name, mid, albumName, album_name, albumID, company, album_mid, albumMID, publicTime, singer_list, singers, desc, pub_time, ar }) => ({
      ...
      company,
      publishTime: publicTime ? moment(publicTime, pub_time).valueOf() : undefined,
